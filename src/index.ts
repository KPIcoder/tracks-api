...
import { genreRouter, trackRouter } from './connect';
import {startHttp3Server} from "./http3";
...
async function start() {
  try {
    ...
    await fastify.register(fastifyConnectPlugin, { routes: genreRouter, prefix: 'api' })
    await fastify.register(fastifyConnectPlugin, { routes: trackRouter, prefix: 'api' })
